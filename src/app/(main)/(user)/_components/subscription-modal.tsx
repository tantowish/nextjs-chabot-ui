          ...
          <AlertDialogDescription className="text-zinx-200">
            <div className="flex flex-col mt-4 gap-2">
                <div className="flex flex-wrap gap-2 items-center">
                    ...
                    <p className="text-2xl md:text-3xl font-semibold">Chabot Plus</p>
                </div>
                ...
                <div className="w-full">
                    <Button className="w-full rounded-2xl bg-[#424242] hover:bg-[#383838] text-zinc-200 py-5">Upgrade to Chabot Plus</Button>
                </div>
            </div>
          </AlertDialogDescription>
        </AlertDialogHeader>
